...
'/Users/ankur/Library/Python/2.7/lib/python/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  u'rlg_price': PermuteEncoder(maxval=2000.0, fieldName='rlg_price', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=2000.0, classifierOnly=True, clipInput=True, minval=0.0, n=PermuteInt(28, 521), fieldname='rlg_price', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1, 30, 180, 360\]:window=1000:field=rlg_price")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1, 30, 180, 360\]:window=1000:field=rlg_price"
