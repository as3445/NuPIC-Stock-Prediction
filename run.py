...
_METRIC_SPECS = (
    MetricSpec(field='rlg_price', metric='multiStep',
               inferenceElement='multiStepBestPredictions',
               params={'errorMetric': 'aae', 'window': 1000, 'steps': 1}),
    MetricSpec(field='rlg_price', metric='trivial',
...
def createModel(modelParams):
  ...
  model.enableInference({"predictedField": "rlg_price"})
  return model
